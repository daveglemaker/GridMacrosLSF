/*******************************************************************************
         ...
         Creation date: Jan 01 2017.
           ...
           SAS version: SAS 9.4M4 SAS Grid Manager 
               Purpose: List Grid Job information for all active users
                 Usage: %gjobsall
            Parameters: none
...
data jobsa94;
   ...
   length job_id $20. user $20. status $20. queue $20. sub_server $50. ex_server $50. jobname $80. month $30. day $30. time $30. 
          temp1 $30. temp2 $30. temp3 $30. temp4 $30. temp5 $30. temp6 $30. temp7 $30. temp8 $30. temp9 $30. temp10 $30. temp11 $30. temp12 $30. temp13 $30. temp14 $30.;
   ...
   *if substr(sasgsub_job_status,1,1)="S" then delete;
   if temp14 ne " " then do;
      jobname=trim(jobname)||trim(month)||trim(day)||trim(time)||trim(temp1)||trim(temp2)||trim(temp3)||trim(temp4)||trim(temp5)||trim(temp6)||trim(temp7)||trim(temp8)||trim(temp9)||trim(temp10)||trim(temp11);
      month=trim(temp12);
      day=trim(temp13);
      time=trim(temp14);
   end;
   else if temp13 ne " " then do;
      jobname=trim(jobname)||trim(month)||trim(day)||trim(time)||trim(temp1)||trim(temp2)||trim(temp3)||trim(temp4)||trim(temp5)||trim(temp6)||trim(temp7)||trim(temp8)||trim(temp9)||trim(temp10);
      month=trim(temp11);
      day=trim(temp12);
      time=trim(temp13);
   end;
   else if temp12 ne " " then do; 
