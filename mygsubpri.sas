/*******************************************************************************
         ...
         Creation date: Jan 18 2017.
           ...
           SAS version: SAS 9.4M4 SAS Grid Manager 
               Purpose: Submit a sas program with sasgsub to priority queue and 
                        List Grid Job information for that job
                 Usage: %mygsubpri(mypgm)
...
File Reference created: results
     ...
     Sample Macro call: %mygsubpri(/myshared_dir/pgms/sleep1.sas)
